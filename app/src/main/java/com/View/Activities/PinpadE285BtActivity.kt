...
class PinpadE285BtActivity : AppCompatActivity(), PinpadE285MVP.View, PinpadE285SelectionListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            recyclerViewPinpad.layoutManager =
                LinearLayoutManager(this@PinpadE285BtActivity, RecyclerView.VERTICAL, false)
            ...
            textViewTitle.text = "Buscando pinpads"
            ...
            btnRestartSearch.setOnClickListener {
                ...
                updateUI(true, "Buscando pinpads")
                restartDiscovery()
    ...
    private fun returnToActivity() {
        ...
        when {
            banderaOrigen.isNullOrEmpty() -> {
                startActivity(Intent(this@PinpadE285BtActivity, LoginActivity::class.java))
            }
            banderaOrigen == "0" -> {
                startActivity(Intent(this@PinpadE285BtActivity, LoginActivity::class.java))
            }
                ...
                if (BluetoothDevice.ACTION_FOUND == action) {
                    ...
                    device?.let { device ->
                        ...
                        if (!device.name.isNullOrEmpty()) {
                            ...
                            if (device.name.startsWith("Verifone") || device.name.startsWith("e285")) {
    ...
    override fun onPositiveButton() {
        ...
        deviceToRemoveBond?.let { device ->
            if (removeBond(device)) {
                preferenceHelper.removePreference(ConstantsPreferences.PREF_PINPAD)
